...
In docker these can be set in the following way. As an environment variable you can set `javaOptions` where you list each option prefixed with `-D`. For example:
