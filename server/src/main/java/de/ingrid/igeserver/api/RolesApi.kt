...
interface RolesApi {
    ...
    @RequestMapping(value = ["/roles/{id}"], produces = [MediaType.APPLICATION_JSON_VALUE], method = [RequestMethod.POST])
    fun createRole(
    ...
    @RequestMapping(value = ["/roles/{id}"], produces = [MediaType.APPLICATION_JSON_VALUE], method = [RequestMethod.DELETE])
    fun deleteRole(
    ...
    @RequestMapping(value = ["/roles/{id}"], produces = [MediaType.APPLICATION_JSON_VALUE], method = [RequestMethod.GET])
    fun getRole(
            @Parameter(description = "The unique id of the role.", required = true) @PathVariable("id") id: String): ResponseEntity<String>

    @Operation(description = "")
    @ApiResponses(value = [ApiResponse(responseCode = "200", description = "Returns the list of roles")])
    @RequestMapping(value = ["/roles"], produces = [MediaType.APPLICATION_JSON_VALUE], method = [RequestMethod.GET])
    ...
    @RequestMapping(value = ["/roles/{id}"], produces = [MediaType.APPLICATION_JSON_VALUE], method = [RequestMethod.PUT])
    fun updateRole(
