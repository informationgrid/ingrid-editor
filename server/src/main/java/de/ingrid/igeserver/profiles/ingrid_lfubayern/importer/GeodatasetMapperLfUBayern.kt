...
class GeodatasetMapperLfUBayern(isoData: IsoImportData, uploadConfig: UploadConfig) : GeodatasetMapper(isoData, uploadConfig) {
    ...
    override fun getKeywords(): List<String> = super.getKeywords(listOf("LfU Bayern Geological Keywords", "LfU Bayern Internal Keywords"))

    fun getGeologicalKeywords(): List<KeyValue> = metadata.identificationInfo[0].identificationInfo?.descriptiveKeywords
