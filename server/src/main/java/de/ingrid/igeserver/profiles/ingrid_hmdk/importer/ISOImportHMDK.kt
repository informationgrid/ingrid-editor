...
@Service
class ISOImportHMDK(val codelistHandler: CodelistHandler, @Lazy val documentService: DocumentService, @Lazy val researchService: ResearchService, val config: Config) : ISOImportProfile {
    override fun handle(
        catalogId: String,
        data: Metadata,
