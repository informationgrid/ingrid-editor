...
@Service
class ISOImportBaw(val codelistHandler: CodelistHandler, @Lazy val documentService: DocumentService, @Lazy val researchService: ResearchService, @Lazy val catalogService: CatalogService, val uploadConfig: UploadConfig) : ISOImportProfile {
    override fun handle(
        catalogId: String,
        data: Metadata,
