...
@Service
class IngridExporterAddressLubwSkdvOk(
    ...
    override val typeInfo =
        ExportTypeInfo(
            ...
            "Ingrid IDF Address LUBW SKDV-OK (Elasticsearch)",
            "Export von Ingrid Adressen ins IDF Format für LUBW SKDV-OK für die Anzeige im Portal ins Elasticsearch-Format.",
            "application/json",
            "json",
