...
@Service
class ISOImportUPSH(val codelistHandler: CodelistHandler, @Lazy val documentService: DocumentService, @Lazy val researchService: ResearchService, @Lazy val bwastrLocatorService: BwastrLocatorService, val uploadConfig: UploadConfig, @Lazy val catalogService: CatalogService) : ISOImportProfile {
