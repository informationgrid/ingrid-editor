...
class IngridExporterNLPV(
    ...
    override val typeInfo =
        ExportTypeInfo(
            ...
            "indexInGridIDFNLPV",
            "Ingrid IDF NLPV (Elasticsearch)",
            "Export von Ingrid Dokumenten ins IDF Format für NLPV für die Anzeige im Portal ins Elasticsearch-Format.",
            "application/json",
            "json",
            listOf("ingrid-nlpv"),
            isPublic = true,
