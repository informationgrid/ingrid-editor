...
class GeodatasetMapperHMDK(metadata: Metadata, codeListService: CodelistHandler, catalogId: String, documentService: DocumentService) :
    GeodatasetMapper(metadata, codeListService, catalogId, documentService) {
