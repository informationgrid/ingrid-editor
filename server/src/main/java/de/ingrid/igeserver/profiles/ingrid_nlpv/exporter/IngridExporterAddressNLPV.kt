...
@Service
class IngridExporterAddressNLPV(
    ...
    override val typeInfo =
        ExportTypeInfo(
            ...
            "indexInGridIDFNLPV",
            "Ingrid IDF Address NLPV (Elasticsearch)",
            "Export von Ingrid Adressen ins IDF Format für NLPV für die Anzeige im Portal ins Elasticsearch-Format.",
            "application/json",
            "json",
            listOf("ingrid-nlpv"),
            false,
