...
@Service
class IngridExporterAddressBkg(
    ...
    override val typeInfo = ExportTypeInfo(
        ...
        "indexInGridIDFBkg",
        "Ingrid IDF Address BKG (Elasticsearch)",
        "Export von InGrid Adressen ins IDF Format für BKG für die Anzeige im Portal ins Elasticsearch-Format.",
        "application/json",
        "json",
        listOf("ingrid-bkg"),
        false,
