...
import de.ingrid.igeserver.profiles.ingrid_bast.exporter.IngridIndexExporterBast
...
) : IngridIndexExporterBast(idfExporter, luceneExporter, documentWrapperRepository) {
