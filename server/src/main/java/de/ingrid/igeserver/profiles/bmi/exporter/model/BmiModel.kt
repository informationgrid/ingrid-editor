...
/*
    ...
    val contactPoint: AddressModel? get() {
        return getAddresses("contactPoint")
    }
    val publisher: AddressModel? get() {
        return getAddresses("publisher")
    }
    val originator: AddressModel? get() {
        return getAddresses("originator")
    }
    val maintainer: AddressModel? get() {
        return getAddresses("maintainer")
    }
    val contributor: AddressModel? get() {
        return getAddresses("contributor")
    }
