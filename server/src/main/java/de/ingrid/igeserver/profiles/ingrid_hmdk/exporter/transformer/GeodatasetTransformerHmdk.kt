...
class GeodatasetTransformerHmdk(transformerConfig: TransformerConfig) : GeodatasetModelTransformer(transformerConfig) {
...
class GeodatasetTransformerHmdkMetaver(transformerConfig: TransformerConfig) : GeodatasetModelTransformer(transformerConfig) {
    override fun getCrossReference(
        uuid: String,
        type: KeyValue?,
        direction: String,
