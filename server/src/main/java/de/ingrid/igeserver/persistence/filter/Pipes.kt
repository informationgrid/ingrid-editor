 ...
 */
open class PersistencePayload(var type: EntityType, var document: ObjectNode, var wrapper: ObjectNode): Payload {
    constructor(type: EntityType, document: ObjectNode) : this(type, document, jacksonObjectMapper().createObjectNode())
}

/**
 * Payload holding document data before inserting the document
 */
open class PreCreatePayload(type: EntityType, document: ObjectNode, val category: String) : PersistencePayload(type, document)

/**
 * Payload holding document data after inserting the document
 */
open class PostCreatePayload(type: EntityType, document: ObjectNode, wrapper: ObjectNode) : PersistencePayload(type, document, wrapper)

/**
 * Payload holding document data before updating the document
 */
open class PreUpdatePayload(type: EntityType, document: ObjectNode, wrapper: ObjectNode) : PersistencePayload(type, document, wrapper)

/**
 * Payload holding document data after updating the document
 */
open class PostUpdatePayload(type: EntityType, document: ObjectNode, wrapper: ObjectNode) : PersistencePayload(type, document, wrapper)

/**
 * Payload holding document data before publishing the document
 */
open class PrePublishPayload(type: EntityType, document: ObjectNode, wrapper: ObjectNode) : PersistencePayload(type, document, wrapper)

/**
 * Payload holding document data after publishing the document
 */
open class PostPublishPayload(type: EntityType, document: ObjectNode, wrapper: ObjectNode) : PersistencePayload(type, document, wrapper)
