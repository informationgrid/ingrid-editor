...
/**
 * Cleanup scheduler after separating cron-trigger from manual indexing. This lead to duplicate triggers and wrong indexing.
 */
@Service
class M093aCleanupScheduler : MigrationBase("0.93.1") {
