...
@Profile("ingrid")
@Service
class M098UpdateInGridDoiCatalogCodelists : MigrationBase("0.98") {
    ...
    override fun exec() {
        ClosableTransaction(transactionManager).use {
            catalogRepo.findAllByType("ingrid").forEach { catalog ->
                ...
                if (catalogCodelists.none { it.id == "3390" }) {
                    ingridProfile.initCatalogCodelists(catalog.identifier, "3390")
                }
            }
        }
    }
