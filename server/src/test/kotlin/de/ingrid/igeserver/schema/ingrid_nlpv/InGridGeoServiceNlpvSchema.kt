...
class InGridGeoServiceNlpvSchema : AnnotationSpec() {

    private val schema = "/ingrid/schemes/nlpv/geo-service_nlpv.schema.json"

    @Test
    fun minimal() {
        var json = SchemaUtils.getJsonFileContent("/export/ingrid/geo-service.minimal.json")
        // geometryContext
