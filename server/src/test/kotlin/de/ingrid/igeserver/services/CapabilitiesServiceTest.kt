                ...
                result.run {
                    ...
                    operations shouldContainExactly listOf(
                        ...
                        OperationBean(
                            ...
                            listOf(7, 8),
                            "DescribeFeatureType",
                            KeyValue("2", "DescribeFeatureType"),
                        ),
                        OperationBean(
                            listOf(
                                "http://gateway.hamburg.de/OGCFassade/HH_WFS_Geotourismus.aspx?",
                ...
                /*spatialReferenceSystems shouldContainExactly listOf(
                    ...
                    operations shouldContainExactly listOf(
                        ...
                        OperationBean(
                            ...
                            listOf(7, 8),
                            "DescribeCoverage",
                            KeyValue(null, "DescribeCoverage"),
                        ),
                        OperationBean(
                            listOf(
                                "http://localhost:8080/wpvs/services?",
                ...
                result.run {
                    ...
                    operations shouldContainExactly listOf(
                        ...
                        OperationBean(
                            ...
                            listOf(7),
                            "Transform",
                            KeyValue("2", "Transform"),
                        ),
                        OperationBean(
                            listOf("www.lat-lon.de/transform"),
                            listOf(7),
                            "IsTransformable",
                            KeyValue("3", "IsTransformable"),
                        ),
                        OperationBean(
                            listOf("www.lat-lon.de/transform"),
                            listOf(7),
                            "GetResourceByID",
                            KeyValue("5", "GetResourceById"),
                        ),
                    )
                    onlineResources shouldContainExactly emptyList()
                    timeSpan shouldBe null
