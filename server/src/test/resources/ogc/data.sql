...
INSERT INTO catalog VALUES (101, 'hmdk_catalog', 'ingrid-hmdk', 'HMDK Catalog', 'HMDK Catalog Description', now(), now(), NULL);

-- users
INSERT INTO user_info VALUES (10, 'user1', 100, '{"recentLogins": [1604100256021]}', 2);
INSERT INTO catalog_user_info VALUES (100, 10);
INSERT INTO catalog_user_info VALUES (101, 10);
...
INSERT INTO document VALUES (1003, 101, '220C6012-1713-44C0-9A33-4E2C24D06966', 'InGridOrganisationDoc', 'Test Document', '{"address": {"country": null, "administrativeArea": {"key": "0"}}, "contact": [{"type": {"key": "3"}, "connection": "you@wemove.com"}], "organization": "Contact Short", "positionName": "", "hoursOfService": ""}',
                             0, '2020-10-09 22:48:28.644575+00', '2020-10-09 22:48:28.644575+00', null, null, null, null, true, 'PUBLISHED'
                            );
...
INSERT INTO document_wrapper VALUES (1003, 101, NULL, '220C6012-1713-44C0-9A33-4E2C24D06966', 'InGridOrganisationDoc', 'address', 0);
