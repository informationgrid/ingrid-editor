...
import {CheckboxField, DropdownField, FieldBase, RadioField, TableField, TextareaField, TextboxField} from './controls';
...
describe('Formular fields', () => {
  ...
  let fixture: any, comp: any;
  const formFieldService = new FormControlService();
  ...
  it('should create a text field', () => {
    const textfield: FieldBase<any> = new TextboxField({
     key: 'ctrl1',
    ...
    const element = fixture.debugElement;
     ...
     comp.form = formFieldService.toFormGroup([textfield], null);
  ...
  it('should create a text area', () => {
    ...
    fixture.whenStable().then(() => {
      const textareaField: FieldBase<any> = new TextareaField({
        key: 'ctrl2',
      ...
      comp.form = formFieldService.toFormGroup([textareaField], null);
      ...
      const textarea = element.query(By.css('textarea')).nativeElement;
  ...
  it('should create a select box', () => {
    // let fixture = TestBed.createComponent(DynamicFieldComponent);
    fixture.whenStable().then(() => {
      const selectField: FieldBase<any> = new DropdownField({
        key: 'ctrlSelect',
      ...
      comp.form = formFieldService.toFormGroup([selectField], null);
  ...
  it('should create a checkbox', () => {
    ...
    fixture.whenStable().then(() => {
      ...
      comp.form = formFieldService.toFormGroup([checkboxField], null);
      ...
      const checkbox = element.query(By.css('input')).nativeElement;
  ...
  it('should create a radio button group with initial state', () => {
    const fixture = TestBed.createComponent(DynamicFieldComponent);
    fixture.whenStable().then(() => {
      const radioField: FieldBase<any> = new RadioField({
        key: 'ctrlRadio',
        label: 'Gender',
        options: [
          {label: 'male', value: 'm'},
      ...
      comp.form = formFieldService.toFormGroup([radioField], null);
      comp.field = radioField;
      comp.value = {ctrlRadio: 'f'};

      fixture.detectChanges(); // trigger change detection
      expect(element.query(By.css('label')).nativeElement.innerText).toBe('Gender');
      const radios = element.queryAll(By.css('input'));
      const radioMale = radios[0].nativeElement;
      const radioFemale = radios[1].nativeElement;
  ...
  xit('should create a table', () => {
    const fixture = TestBed.createComponent(DynamicFieldComponent);
    fixture.whenStable().then(() => {
      const selectField: FieldBase<any> = new TableField({
        key: 'ctrlTable',
      ...
      // expect(1).toBe(2);
      /*const rows = element.query( By.css( '.ag-body-viewport .ag-row' ) );
      ...
      const headerCells = element.queryAll(By.css('.ag-header-cell'));
