...
export class AutosavePlugin extends Plugin {
  id = "plugin.autosave";
  name = "Automatisches Speichern - Plugin";
  description =
    "Erfolgt nach 10min keine weitere Eingabe, wird der Datensatz automatisch gespeichert, insofern Änderungen vorgenommen worden sind.";
  // group = "Toolbar";
  defaultActive = false;
  hide = false;
