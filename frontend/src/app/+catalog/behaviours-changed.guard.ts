...
export class BehavioursChangedGuard implements CanDeactivate<CatalogSettingsComponent> {

  constructor(private dialog: MatDialog) {
  }

  canDeactivate(component: CatalogSettingsComponent): Observable<boolean> | boolean {
