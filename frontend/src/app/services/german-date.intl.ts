...
@Injectable()
export class GermanDateIntl extends MatDatepickerIntl {
  calendarLabel = "Kalender Dialog";
  ...
  switchToMonthViewLabel = "Monatsansicht";
  switchToMultiYearViewLabel = "Jahresansicht";
