...
describe('Document Type', () => {
  ...
  it('should add context help info to fields correctly', () => {
    ...
    expect(doctype.fields[initialFieldLength].templateOptions.hasContextHelp).toBeTruthy();
    expect(doctype.fields[initialFieldLength + 1].fieldGroup[0].templateOptions.hasContextHelp).toBeTruthy();
  });
});
